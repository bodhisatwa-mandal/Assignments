...
QT_MOC_LITERAL(1, 9, 17), // "sendMousePosition"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "QPoint&"
QT_MOC_LITERAL(4, 36, 9) // "Mouse_Pos"

    },
    "my_label\0sendMousePosition\0\0QPoint&\0"
    "Mouse_Pos"
};
...
void my_label::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (my_label::*_t)(QPoint & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&my_label::sendMousePosition)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&my_label::Mouse_Pos)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject my_label::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_my_label.data,
      qt_meta_data_my_label,  qt_static_metacall, nullptr, nullptr}
};
