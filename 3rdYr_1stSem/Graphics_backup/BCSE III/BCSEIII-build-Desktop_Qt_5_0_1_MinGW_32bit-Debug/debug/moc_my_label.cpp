...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_my_label_t, stringdata) + ofs \
...
const QMetaObject my_label::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_my_label.data,
      qt_meta_data_my_label,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_my_label.stringdata))
